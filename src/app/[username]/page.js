          ...
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <div className="md:hidden grid grid-cols-3 gap-2 pt-2 border-t border-[#2a3645]">
              <div className="text-center">
                ...
                <p className="text-[10px] text-stone-400 uppercase tracking-wider mt-0.5">Este año</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">{stats?.monthlyListens || 0}</p>
                <p className="text-[10px] text-stone-400 uppercase tracking-wider mt-0.5">Este mes</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-white">0</p>
                <p className="text-[10px] text-stone-400 uppercase tracking-wider mt-0.5">Por escuchar</p>
              </div>
            </div>
          </div>
        </div>
